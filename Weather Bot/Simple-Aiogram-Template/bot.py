...
async def start_command(message:Message):
    ...
    try:
        ...
        await message.answer(text="Assalomu alaykum, ob-havo botimizga xush kelibsiz ⛅️ \nViloyatni tanlang!",reply_markup=inline_menu)
...
async def help_commands(message:Message):
    await message.answer("/start botni ishga tushiradi \n /about biz haqimizda")
...
async def about_commands(message:Message):
    await message.answer("Men Raxmatillayev Boburjon qwertyuiop[]")
...
# @dp.callback_query(F.data=="toshkent")
# async def toshkent_harorat(callback:CallbackQuery):
...
#     toshkent = ob_havo(city=city.get("Toshkent"))
#     await callback.message.edit_text(text=f"Toshkent: {toshkent}",reply_markup=uchir)   
